...
styles: {
    // By using styles/**/*.sass we're telling gulp to check all folders for any sass file
        src: "./credit-clinic/src/scss/*.scss",
    // Compiled files will end up in whichever folder it's found in (partials are not compiled)
        dest: "./credit-clinic/dist/css/"
},php: {
        src: './credit-clinic/*.html',
},
scripts: {
    src: "./credit-clinic/src/js/*.js",
    dest: "./credit-clinic/dist/js/"
}
...
function watch() {
    ...
    browserSync.init({
      ...
      port: 8181,
        proxy: "http://192.168.12.3:8888/projects/landing-pages/credit-clinic/"
